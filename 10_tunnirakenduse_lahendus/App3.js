  ...
  return (
    <div>
      ...
      <table style={{marginLeft: "100px"}}>
        <thead>
          <tr style={{border: "1px solid #ddd", padding: "12px", backgroundColor: "#04AA6D"}}>Ajatempel</tr>
          <tr style={{border: "1px solid #ddd", padding: "12px", backgroundColor: "#04AA6D"}}>Hind</tr>
        </thead>
        <tbody>
